...
@Mapper
public interface UserPublicInformationMapper {
    @ValueMappings({
    ...
    UserPublicInformationDto convertFromUserEntity(UserEntity userEntity);

    List<UserPublicInformationDto> convertFromUserEntityList(List<UserEntity> userList);
